...
public class DirectionBoostAbility : AbilityParent
{
    ...
    public void activate()
    {
        ...
        Vector3 boostAxis = Camera.main.transform.forward;

        if (Input.GetKey(KeyCode.A)) // boost left
        {
            boostAxis = -Camera.main.transform.right;
        }
        else if (Input.GetKey(KeyCode.D)) // boost right
        {
            boostAxis = Camera.main.transform.right;
        }
        else if (Input.GetKey(KeyCode.S)) // boost backwards
        {
            boostAxis = -Camera.main.transform.forward;
        }

        myRb.velocity += boostAxis * boostVelocity;
    ...
    public void copyOther(AbilityParent other)
    {
        ...
        DirectionBoostAbility otherBoost = (DirectionBoostAbility)other;
    ...
    public void equipAbilityToAircraftObject(GameObject aircraftObj)
    {
        ...
        DirectionBoostAbility equippedBoost = aircraftObj.AddComponent<DirectionBoostAbility>();
